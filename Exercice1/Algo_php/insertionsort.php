...
function insertionSort($arr) {
    ...
    /* On entre dans la boucle while imbirquee dans la boucle for pour commencer le tri par insertion
    ...
    // Ici, comme la variable $arr[$i] etatit videe , on la reutilise pour y stocker l'element du tableau d'indice egal la valeur dans $j
            $arr[$j + 1] = $arr[$j];
